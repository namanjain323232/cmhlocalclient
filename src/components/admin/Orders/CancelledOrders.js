...
import { fetchCancelledOrders } from "../../../actions/orders";
...
const CancelledOrders = () => {
  ...
  const getOrders = async () => {
    setLoading(true);
    fetchCancelledOrders().then((res) => setOrders(res.data));
    setLoading(false);
  };
    ...
    <div className="row">
      ...
      <div className="col col-md-6 category">
        ...
        {!orders ? (
          ...
          <h2 className="card-header font-weight-bold mt-2">Cancelled Orders</h2>
        )}
